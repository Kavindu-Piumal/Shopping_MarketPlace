...
const PrivacyConsentBanner = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-yellow-50 to-orange-50 border-t-2 border-yellow-200 p-4 shadow-lg z-50">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
                <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <h3 className="font-semibold text-yellow-800">Chat Privacy Notice</h3>
                    </div>
                ...
                <div className="flex gap-3">
                    <button
                        ...
                        className="px-4 py-2 text-sm text-yellow-700 border border-yellow-300 rounded-lg hover:bg-yellow-100 transition"
                    >
                        View Policy
                    </button>
                    <button
